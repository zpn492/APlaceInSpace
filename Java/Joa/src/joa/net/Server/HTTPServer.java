...
import BrandtTubes.Sock;
import BrandtTubes.Tube;
...
public class HTTPServer extends ServerController<ServerSocket> {
    ...
    public class HTTPEntryPoint extends BrandtServer.EntryPoint {
        @Override
    ...
    private class HTTPHandler extends Thread {
        ...
        public void run() {
            ...
            // Retrieve file
            arc = new BrandtArchive.Archive(filepath);
            ...
            if(type.equals("php") && arc.isInitialized()) {
                ...
                Process p = BrandtTubes.SysProcess.createProcess(args);
                BrandtTubes.Tube cp = new BrandtTubes.Tube(p);
            ...
            if(!arc.isInitialized()) {
                arc = new BrandtArchive.Archive("pagenotfound.html");
                range = false;
        ...
        private BrandtArchive.Archive arc;
